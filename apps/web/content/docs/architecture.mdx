---
title: Architecture
description: High-level architecture of the Budget App monorepo.
---
...
| ----- | ------------ | ---------------------------- |
| `web` | `@repo/web`  | Main Next.js web application |
| `api` | `@repo/api`  | NestJS backend API server    |
...
- **Ecosystem**: Rich module ecosystem (Swagger, Prisma, etc.)
